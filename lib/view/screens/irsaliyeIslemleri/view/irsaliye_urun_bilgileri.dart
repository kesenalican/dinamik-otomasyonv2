...
class IrsaliyeUrunBilgileri extends HookConsumerWidget {
  final GlobalKey<FormState> formKey = GlobalKey<FormState>();
  IrsaliyeUrunBilgileri({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: const CommonAppbar(whichPage: Constants.urunEkle),
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              //*Stok Miktarı
              buildMiktarField(context, siparisMiktariController, focusNode,
                  netFiyat, siparisModel),
              SizedBox(
  ...
  Padding buildMiktarField(
      BuildContext context,
      TextEditingController siparisMiktariController,
      FocusNode focusNode,
      ValueNotifier<double> netFiyat,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          //*Toplam Tutar
          buildToplamTutar(context, netFiyat, siparisModel),
        ],
      ),
    );
  }

  Padding buildToplamTutar(BuildContext context, ValueNotifier<double> netFiyat,
      SatisSiparisiViewModel siparisModel) {
    return Padding(
      padding: context.paddingDefault,
      child: Row(
